...
export class AppComponent implements OnInit {
  ...
  private default_city = 'mykolayiv' // TEMP! Geo will be added soon
  private get_weather = 'http://api.openweathermap.org/data/2.5/weather?q='+ this.default_city +'&appid='+ this.api_key;
  weatherJSON:any = {};
  weather = 'true';
  weather_icon: string;
  weather_icons = {
  ...
  getWeatherJSON() {
    ...
    .subscribe(data => {
      ...
      let prefix = 'wi wi-';
      let code = this.weatherJSON.weather[0].id;
